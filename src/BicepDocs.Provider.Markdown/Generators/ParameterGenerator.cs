...
{
    internal static void BuildParameters(MarkdownDocument document, GeneratorOptions options,
    ...
    internal static void BuildParameterReferences(MarkdownDocument document, GeneratorOptions options,
        ImmutableList<ParsedParameter> parameters)
    {
